...
PohodaReceipeInRequest::PohodaReceipeInRequest()
{

}

QString PohodaReceipeInRequest::getRequest(const QString &ico, const SReceipeHeader &header, const QList<SReceipeItem> &list)
{
    QDomDocument xmlDoc;
    QString xmlText("");
    QString tagName("");
...
void PohodaReceipeInRequest::setResponse(const QString &responseXml)
{
    QDomDocument xmlDoc;
