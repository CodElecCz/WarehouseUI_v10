...
PohodaVydejkaRequest::PohodaVydejkaRequest()
{

}

QString PohodaVydejkaRequest::getRequest(const QString &ico, const SReceipeHeader &header, const QList<SReceipeItem> &list)
{
    QDomDocument xmlDoc;
    QString xmlText("");
    QString tagName("");
...
void PohodaVydejkaRequest::setResponse(const QString &responseXml)
{
    QDomDocument xmlDoc;
